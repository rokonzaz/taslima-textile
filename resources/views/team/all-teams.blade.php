...
@section('additionalButton')
    <div class="tooltip tooltip-left"  data-tip="Create Team">
        <button onclick="initializeSelectize('c_department_head','get-department_head-list', '');createTeamModal.showModal();" class="actionBtn bg-[#831b94]"><i class="fa-solid fa-circle-plus"></i></button>
    </div>
@endsection
@section('content')
