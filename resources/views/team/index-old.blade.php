        ...
        <div class="grid grid-cols-4 divide-x">
            <div class="pr-2">
                <div class="flex justify-between items-center">
                    ...
                    <button onclick="initializeSelectize('c_department_head','get-department-head-list', '');createTeamModal.showModal();" class="actionBtn bg-[#831b94]"><i class="fa-solid fa-circle-plus"></i></button>
                </div>
