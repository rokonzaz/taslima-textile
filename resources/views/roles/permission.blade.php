...
@section('content')
    ...
    <div class="flex flex-col p-4 border rounded-lg dark:bg-neutral-800 border-neutral-200 dark:border-neutral-700">
        <h1 class="pb-2">
            ...
            <b class="text-xl italic text-[#831b94] uppercase dark:text-[#831b94]">{{ $role->name }} :</b>
        </h1>
        <div
            ...
            @foreach ($categoriWisePermission as $key => $permission)
                <button type="button" onclick="scrollToSection('section{{ $key }}')"
                    class="px-2 py-0 text-sm font-medium text-gray-800 dark:text-white hover:text-[#831b94] dark:hover:text-[#831b94]">{{ ucfirst($key) }}</button>
            @endforeach
            ...
            <div class="grid  rounded-[5px] gap-x-10 gap-y-4">
                    ...
                    <div class="py-4" id="section{{ $key }}">
                        <div
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <label
                                    class="flex items-center justify-between p-2 rounded-md cursor-pointer label gap-y-6 hover:bg-[#831b94] dark:hover:bg-[#831b94] hover:text-white">
                            ...
                            @foreach ($permission as $item)
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-6 ">
                                    <div class="col-span-3">
                                        <label
                                            class="flex items-center justify-between p-2 rounded-md cursor-pointer label gap-y-6 hover:bg-[#831b94] hover:text-white">
                                            <span
                ...
                <div class="relative flex items-center justify-end col-span-3 gap-2 mt-8 mb-0">
                    <div class="relative flex items-center justify-center mb-3 transition duration-150 ease-in-out rounded-md"
                        ...
                        <a href="{{ url('/roles') }}"
                            class="inline-flex items-center ml-[-8px] px-6 py-2 text-sm font-medium text-center text-white bg-red-700 rounded-lg hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-[#831b94] dark:hover:bg-red-700 dark:focus:ring-red-800">
                            Cancel
                        </a>
                        <button type="reset"
                            class="inline-flex items-center px-6 py-2 ml-4 text-sm font-semibold text-[#831b94] border rounded-lg border-neutral-300 gap-x-2 hover:border-red-600 hover:text-[#831b94] disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-[#831b94] dark:hover:border-red-600 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700"
                            data-te-ripple-init data-te-ripple-color="light">
                            Reset
                        </button>
