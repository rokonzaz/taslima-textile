...
@section('breadcumb')
    <ol class="flex items-center mt-2 whitespace-nowrap mr-2">
        <li class="inline-flex items-center">
            <a class="flex items-center text-sm text-gray-500 hover:text-[#831b94] focus:outline-none focus:text-neutral-600 dark:focus:text-neutral-600"
               href="#">
        ...
        <li class="inline-flex items-center text-sm font-semibold text-[#831b94] truncate dark:text-[#831b94]"
            aria-current="page">
            Edit Role
        </li>
    </ol>
        ...
        <div class="">
            <div class="w-full mt-4">
                <form action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="p-5 pt-3">
                        <h3 class="text-xl text-gray-600 dark:text-neutral-200"><i class="fa-solid fa-user-shield text-primary"></i> Edit for: <span class="font-semibold text-[#831b94] dark:text-red-800">admin</span> </h3>
                        <hr class="my-2 mb-4 border-neutral-200 dark:border-neutral-700">
                        <div class=" flex gap-6 pt-6">
                            <div class="">
                                <div class="flex items-center mt-2">
                                    <label for="checkbox" class="block text-[#831b94] text-sm font-bold">Is Active?</label>
                                    <div class="form-control">
                                        <label class="cursor-pointer label">
                                            <input type="checkbox" name="is_active" class="shrink-0 mt-0.5 border-gray-200 rounded text-[#831b94] focus:ring-red-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:checked:bg-red-500 dark:checked:border-red-500 dark:focus:ring-offset-red-800 ml-2 " checked="">
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="flex items-center gap-1">
                                <button type="submit" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-red-700 rounded-lg hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-[#831b94] dark:hover:bg-red-700 dark:focus:ring-red-800">Update</button>
