...
@section('pageTitle', 'Organization List')
@section("breadcumb")
    <ol class="flex items-center mt-2 mr-2 whitespace-nowrap">
        <li class="inline-flex items-center">
            <a
                class="flex items-center text-sm text-gray-500 hover:text-[#831b94] focus:text-neutral-600 focus:outline-none dark:hover:text-[#831b94] dark:focus:text-neutral-600"
                href="#"
            >
                <svg
            ...
            <svg
                class="flex-shrink-0 mx-2 overflow-visible text-gray-400 size-4 dark:text-neutral-600 dark:hover:text-[#831b94]"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
                viewBox="0 0 24 24"
        ...
        <li
            class="inline-flex items-center text-sm font-semibold text-[#831b94] truncate dark:text-[#831b94] dark:hover:text-[#831b94]"
            aria-current="page"
        >
            Organization
        </li>
            ...
            <div class="-m-1.5 overflow-x-auto">
                <div class="w-full p-1.5 align-middle">
                    <div class="overflow-x-auto">
                        <div>
                            <h3 class="m-2 text-xl font-semibold text-gray-800 dark:text-white">Create New Organization</h3>
                        </div>
                        <form
                        ...
                        >
                            ...
                            <div class="m-2">
                                ...
                                <div class="max-w-full mt-3">
                                    <label for="company_name" class="block mb-2 text-sm font-medium text-gray-800 dark:text-white">Organization Name</label>
