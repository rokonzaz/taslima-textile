<x-modals.small-modal id="editTeamModal" title="Edit a Team">
    <form action="{{route('team.update', ['id'=>$team->id])}}" method="POST" class="mb-0" enctype="multipart/form-data" onsubmit="">
        @csrf
        <div class="p-4">
            <div class="grid grid-cols-1 gap-1 mt-2">
                ...
                <div class="col-span-1 relative">
                    ...
                    <div id="supervisor-spinner" class="absolute right-10 bottom-4 z-10">
