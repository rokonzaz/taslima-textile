<x-modals.small-modal id="createTeamModal" title="Create a Team">
    <form action="{{route('team.store')}}" method="POST" class="mb-0" enctype="multipart/form-data" onsubmit="return validateFormRequest('c_', 'team')">
        @csrf
        <div class="p-4">
            <div class="grid grid-cols-1 gap-1 mt-2">
                ...
                <div class="col-span-1 relative">
                    ...
                    <select id="c_supervisor" name="supervisor[]" class="" placeholder="Select a Supervisor..."></select>
