...
$ativeSubClass='text-sm text-[#831b94] font-bold dark:text-[#831b94] active:text-[#831b94] active:font-bold active:bg-[#831b94] dark:active:text-[#831b94] hs-accordion-active:text-[#831b94] hs-accordion-active:font-bold dark:hs-accordion-active:text-[#831b94]';
...
<div id="application-sidebar" class="hs-overlay hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform hidden fixed top-0 start-0 bottom-0 z-[60] w-64 bg-white border-e border-gray-200 pt-7 pb-10 overflow-y-auto lg:block lg:translate-x-0 lg:end-auto lg:bottom-0 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-slate-700 dark:[&::-webkit-scrollbar-thumb]:bg-slate-500 dark:bg-neutral-800 dark:border-neutral-700 dark:hs-overlay-backdrop-open:bg-neutral-900/90 print:hidden">
    <div class="px-6">
        <a class="flex-none text-xl font-semibold dark:text-white" href="/" aria-label="Brand">
            <img src="assets/img/logo-taslima.png" alt="Nexdecade Logo"></a>
    </div>

    <nav class="flex flex-col flex-wrap w-full p-4 py-6 hs-accordion-group" data-hs-accordion-always-open>
                    ...
                    <div id="staff-accordion-child" class="hs-accordion-content w-full overflow-hidden transition-[height] duration-300 hidden" {{$isActive =='true' ? 'style=display:block;' : ''}}>
                        <ul class="flex flex-col gap-1 pt-2 ml-3 ps-2">
                            @if(userCan('employee.view'))
                                ...
                                <li>
                                    <a href="{{route('employees.index')}}" class="{{$isSubActive=='true' ? $ativeSubClass : ''}} flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-black rounded-lg hover:bg-[#831b94] dark:hover:bg-[#831b94] hover:text-white dark:text-white dark:hover:text-white dark:focus:outline-none ">
                            ...
                            @if(userCan('employee.view'))
                                ...
                                <li>
                                    <a href="{{route('designation.index')}}" class="{{$isSubActive=='true' ? $ativeSubClass : ''}} flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-black rounded-lg hover:bg-[#831b94] dark:hover:bg-[#831b94] hover:text-white dark:text-white dark:hover:text-white dark:focus:outline-none ">
                    ...
                    <div id="staff-accordion-child" class="hs-accordion-content w-full overflow-hidden transition-[height] duration-300 hidden" {{$isActive =='true' ? 'style=display:block;' : ''}}>
                        <ul class="flex flex-col gap-1 pt-2 ml-3 ps-2">
                            @if(userCan('employee.view'))
                                ...
                                <li>
                                    <a href="{{ route('department.index') }}" class="{{$isSubActive=='true' ? $ativeSubClass : ''}} flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-black rounded-lg hover:bg-[#831b94] dark:hover:bg-[#831b94] hover:text-white dark:text-white dark:hover:text-white dark:focus:outline-none ">
                        ...
                        <ul class="flex flex-col gap-1 pt-2 ml-3">
                            @if(userCan('leave.view'))
                                @if(in_array(getUserRole(), ['super-admin', 'hr', 'department-head', 'team-lead']))
                                    ...
                                    <li>
                                        <a href="{{route('leave.index')}}" class="{{ $isSubActive == 'true' ? $ativeSubClass : ''}} flex items-center gap-x-1 py-1.5 px-2 text-sm text-black rounded-lg hover:bg-[#831b94] dark:hover:bg-[#831b94] hover:text-white dark:text-white dark:hover:text-white dark:focus:outline-none ">
                            ...
                            @if(in_array(getUserRole(), ['super-admin', 'hr']))
                                ...
                                <li>
                                    <a  href="{{ route('holiday.index') }}" class="{{$isSubActive=='true' ? $ativeSubClass : ''}} flex items-center gap-x-1 py-1.5 px-2 text-sm text-black rounded-lg hover:bg-[#831b94] dark:hover:bg-[#831b94] hover:text-white dark:text-white dark:hover:text-white dark:focus:outline-none">
                            ...
                            @if(in_array(getUserRole(), ['super-admin', 'hr']))
                                ...
                                <li>
                                    <a  href="{{ route('weekend.index') }}" class="{{$isSubActive=='true' ? $ativeSubClass : ''}} flex items-center gap-x-1 py-1.5 px-2 text-sm text-black rounded-lg hover:bg-[#831b94] dark:hover:bg-[#831b94] hover:text-white dark:text-white dark:hover:text-white dark:focus:outline-none">
                            ...
                            @if(in_array(getUserRole(), ['super-admin', 'hr']))
                                ...
                                <li>
                                    <a  href="{{ route('leave-type.index') }}" class="{{$isSubActive=='true' ? $ativeSubClass : ''}} flex items-center gap-x-1 py-1.5 px-2 text-sm text-black rounded-lg hover:bg-[#831b94] dark:hover:bg-[#831b94] hover:text-white dark:text-white dark:hover:text-white dark:focus:outline-none">
                            ...
                            @if(userCan('leave.view'))
                                ...
                                <li>
                                    <a href="{{route('leave.index', ['a'=>'my-leave-list'])}}" class="{{$isSubActive=='true' ? $ativeSubClass : ''}} flex items-center gap-x-1 py-1.5 px-2 text-sm text-black rounded-lg hover:bg-[#831b94] dark:hover:bg-[#831b94] hover:text-white dark:text-white dark:hover:text-white dark:focus:outline-none">
                                        <span class="text-base {{$isSubActive == 'true' ? 'font-bold' : 'font-semibold'}}"><i class="ti ti-point"></i></span>  My Leave List
                                    </a>
                                </li>
                                    @php $isSubActive = request()->is('leave') && request()->has('a') && request('a')=='my-leave-list' && request('req')=='true' ? 'true' : 'false'; @endphp
                                <li>
                                    <a href="{{route('leave.index', ['a'=>'my-leave-list', 'req'=>'true'])}}" class="{{$isSubActive=='true' ? $ativeSubClass : ''}} flex items-center gap-x-1 py-1.5 px-2 text-sm text-black rounded-lg hover:bg-[#831b94] dark:hover:bg-[#831b94] hover:text-white dark:text-white dark:hover:text-white dark:focus:outline-none">
                    ...
                    <div id="timesheet-accordion-child" class="hs-accordion-content w-full overflow-hidden transition-[height] duration-300 hidden" {{$isActive =='true' ? 'style=display:block;' : ''}}>
                        <ul class="flex flex-col gap-1 pt-2 ml-3">
                            @if(userCan('attendance.view'))
                                ...
                                <li>
                                    <a href="{{route('attendance.index')}}" class="{{ $isSubActive == 'true' ? $ativeSubClass : ''}} flex items-center gap-x-1 py-1.5 px-2 text-sm text-black rounded-lg hover:bg-[#831b94] dark:hover:bg-[#831b94] hover:text-white dark:text-white dark:hover:text-white dark:focus:outline-none">
                            ...
                            @if(userCan('duty-slot.view'))
                                ...
                                <li>
                                    <a href="{{route('dutySlots.index')}}" class="{{ $isSubActive == 'true' ? $ativeSubClass : ''}} flex items-center gap-x-1 py-2 px-2.5 text-sm text-black rounded-lg hover:bg-[#831b94] dark:hover:bg-[#831b94] hover:text-white dark:text-white dark:hover:text-white dark:focus:outline-none ">
                    ...
                    <div id="staff-accordion-child" class="hs-accordion-content w-full overflow-hidden transition-[height] duration-300 hidden" {{$isActive =='true' ? 'style=display:block;' : ''}}>
                        <ul class="flex flex-col gap-1 pt-2 ml-3">
                            @if(userCan('reports.view'))
                                ...
                                <li>
                                    <a href="{{route('reports.index', ['a'=>'attendance-report'])}}" class="{{$isSubActive=='true' ? $ativeSubClass : ''}} flex items-center gap-x-1 py-2 px-2.5 text-sm text-black rounded-lg hover:bg-[#831b94] dark:hover:bg-[#831b94] hover:text-white dark:text-white dark:hover:text-white dark:focus:outline-none ">
                            ...
                            @if(userCan('reports.view'))
                                ...
                                <li>
                                    <a href="{{route('reports.index', ['a'=>'leave-report'])}}" class="{{$isSubActive=='true' ? $ativeSubClass : ''}} flex items-center gap-x-1 py-2 px-2.5 text-sm text-black rounded-lg hover:bg-[#831b94] dark:hover:bg-[#831b94] hover:text-white dark:text-white dark:hover:text-white dark:focus:outline-none ">
                            ...
                            @if(userCan('reports.view'))
                                ...
                                <li>
                                    <a href="{{route('reports.index', ['a'=>'employee-report'])}}" class="{{$isSubActive=='true' ? $ativeSubClass : ''}} flex items-center gap-x-1 py-2 px-2.5 text-sm text-black rounded-lg hover:bg-[#831b94] dark:hover:bg-[#831b94] hover:text-white dark:text-white dark:hover:text-white dark:focus:outline-none ">
                    ...
                    <div id="staff-accordion-child" class="hs-accordion-content w-full overflow-hidden transition-[height] duration-300 hidden" {{$isActive =='true' ? 'style=display:block;' : ''}}>
                        <ul class="flex flex-col gap-1 pt-2 ml-3">
                            @if(userCan('user.view'))
                                ...
                                <li>
                                    <a href="{{route('users.index')}}" class="{{$isSubActive=='true' ? $ativeSubClass : ''}} flex items-center gap-x-1 py-2 px-2.5 text-sm text-black rounded-lg hover:bg-[#831b94] dark:hover:bg-[#831b94] hover:text-white dark:text-white dark:hover:text-white dark:focus:outline-none ">
                            ...
                            @if(userCan('role.view'))
                                ...
                                <li>
                                    <a href="{{route('roles.index')}}" class="{{$isSubActive=='true' ? $ativeSubClass : ''}} flex items-center gap-x-1 py-2 px-2.5 text-sm text-black rounded-lg hover:bg-[#831b94] dark:hover:bg-[#831b94] hover:text-white dark:text-white dark:hover:text-white dark:focus:outline-none ">
                    ...
                    <div id="staff-accordion-child" class="hs-accordion-content w-full overflow-hidden transition-[height] duration-300 hidden" {{$isActive =='true' ? 'style=display:block;' : ''}}>
                        <ul class="flex flex-col gap-1 pt-2 ml-3 ps-2">
                            @if(userCan('team.view'))
                                ...
                                <li>
                                    <a href="{{route('team.index')}}" class="{{$isSubActive=='true' ? $ativeSubClass : ''}} flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-black rounded-lg hover:bg-[#831b94] dark:hover:bg-[#831b94] hover:text-white dark:text-white dark:hover:text-white dark:focus:outline-none ">
                    ...
                    <div id="staff-accordion-child" class="hs-accordion-content w-full overflow-hidden transition-[height] duration-300 hidden" {{$isActive =='true' ? 'style=display:block;' : ''}}>
                        <ul class="flex flex-col gap-1 pt-2 ml-3">
                            @if(userCan('notice.view'))
                                ...
                                <li>
                                    <a href="{{route('notice.index')}}" class="{{$isSubActive=='true' ? $ativeSubClass : ''}} flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-black rounded-lg hover:bg-[#831b94] dark:hover:bg-[#831b94] hover:text-white dark:text-white dark:hover:text-white dark:focus:outline-none ">
                    ...
                    <div id="setting-accordion-child" class="hs-accordion-content w-full overflow-hidden transition-[height] duration-300 hidden" {{$isActive =='true' ? 'style=display:block;' : ''}}>
                        <ul class="flex flex-col gap-1 pt-2 ml-3">
                            ...
                            @if(in_array(getUserRole(), ['super-admin', 'hr']))
                                ...
                                <li>
                                    <a  href="{{ route('settings.department.index') }}" class="{{$isSubActive=='true' ? $ativeSubClass : ''}} flex items-center gap-x-1 py-2 px-2.5 text-sm text-black rounded-lg hover:bg-[#831b94] dark:hover:bg-[#831b94] hover:text-white dark:text-white dark:hover:text-white dark:focus:outline-none ">
