...
@section('content')
    ...
    <form action="{{route('attendance.bulk-tag-submit')}}" method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <div
                ...
                <div class="p-4">
                    <label class="block mb-2 text-sm text-gray-800 dark:text-neutral-400">
                        <a href="{{asset('excel/bulk_tag_em_id_sample.xlsx')}}" download="Bulk_tag_sample_{{date('d-m-Y')}}_{{time()}}.xlsx" class="text-sm text-[#831b94] dark:text-red-500 dark:hover:text-[#831b94] hover:underline dark:hover:underline font-medium dark:font-medium">Download a
                            sample XLSX
                    ...
                    <div class="flex justify-center my-4 border border-neutral-600 border-dashed rounded-md dark:border-neutral-400 dark:bg-neutral-800"
                        ...
                        <label class="flex flex-col items-center w-full transition cursor-pointer hover:border-red-600"
                            ...
                            <span class="text-sm text-gray-800 dark:text-white">Drop XLS or XLSX file here or <span
                                    class="text-[#831b94] underline">browse</span></span>
    ...
    <script>
        ...
        $(function (){
            $('#submitButton').click(function (){
                $('#submitButton').html($('#spinner-small-white').html()+' Importing...')
            })
        })
    </script>
@endsection
