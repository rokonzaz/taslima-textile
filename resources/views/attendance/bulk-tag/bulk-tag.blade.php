                    ...
                    <div
                        ...
                        <div class="p-4">
                            <label class="block mb-2 text-sm text-gray-800 dark:text-neutral-400">
                                <a href="{{asset('excel/EmployeeTemplate.xlsx')}}" download="EmployeeTemplate_{{date('d-m-Y')}}_{{time()}}.xlsx" class="text-sm text-[#831b94] dark:text-red-500 dark:hover:text-[#831b94] hover:underline dark:hover:underline font-medium dark:font-medium">Download a
                                    sample XLSX
