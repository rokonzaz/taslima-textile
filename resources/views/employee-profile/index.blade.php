        ...
        <div class="bg-white border border-gray-200 rounded-lg dark:bg-neutral-800 -800 dark:border-gray-700">
                ...
                <div class="relative inline-flex hs-dropdown">
                    ...
                    <div
                        ...
                        aria-labelledby="hs-dropdown-custom-icon-trigger">
                         ...
                         <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-[#831b94] hover:text-white dark:text-gray-400 dark:hover:bg-red-700 dark:hover:text-white"
            ...
            <div class="flex flex-col items-center pb-10">
                ...
                <img class="w-24 h-24 mb-3 rounded-full shadow-lg"
                     ...
                     alt="Bonnie image" />
                <h5 class="mb-1 text-xl font-medium text-[#831b94] dark:text-[#831b94]">{{ $employee->full_name}}</h5>
                ...
                <div class="flex mt-2 md:mt-2">
                    <a href="#"
                       class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-[#831b94] rounded-lg hover:bg-red-700 dark:bg-[#831b94] dark:hover:bg-red-700 hover:text-white dark:text-white">#{{ $employee->emp_id}}</a>
