<x-modals.large-modal id="createEmployeeModal" title="Create a new employee">
    <form class="mb-0" action="{{ route('employees.store') }}" method="POST" enctype="multipart/form-data" class="mb-0" onsubmit="return validateEmployeeData()">
        @csrf
        ...
        <div class="p-4 overflow-y-scroll max-h-[70vh]">
            ...
            <div class="mt-1">
                <div id="employee-tab-1" role="tabpanel" aria-labelledby="employee-tab-item-1">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-4  gap-y-0 lg:gap-x-6 lg:gap-y-1 pb-4">
                        <div>
                            <label for="employeeFullName" class="inline-block text-sm font-medium text-gray-800 mt-2.5 dark:text-neutral-200">Full Name <span class="text-[#831b94]">*</span></label>
                        ...
                        <div>
                            <label for="employeeId"  class="inline-block text-sm font-medium text-gray-800 mt-2.5 dark:text-neutral-200">
                                Employee ID <span class="text-[#831b94]">*</span>
                            </label>
                        ...
                        <div>
                            ...
                            <select id="employeeOrganization" name="organization" class="inputField">
                        ...
                        <div>
                            <label for="employeeEmail" class="inline-block text-sm font-medium text-gray-800 mt-2.5 dark:text-neutral-200">
                                Email <span class="text-[#831b94]">*</span>
                            </label>
                        ...
                        <div>
                            <label for="employeePhone"  autocomplete="off" class="inline-block text-sm font-medium text-gray-800 mt-2.5 dark:text-neutral-200">
                                Phone <span class="text-[#831b94]">*</span>
                            </label>
                ...
                <div id="employee-tab-2" class="hidden" role="tabpanel" aria-labelledby="employee-tab-item-2">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-x-6 lg:gap-y-0 mt-2">
                        ...
                        <div>
                            <label for="employeeBloodGroup" class="inputLabel">
                                Enter Blood Group
                            </label>
...
<script>
    function activeTab(tabId) {
        if(tabId==='employee-tab-item-1'){
            $('#employee-tab-item-1').addClass('active border-b-red-600 text-[#831b94]');
            $('#employee-tab-item-2').removeClass('active border-b-red-600 text-[#831b94]');
            $('#employee-tab-1').removeClass('hidden');
            $('#employee-tab-2').addClass('hidden');
        }
        if(tabId==='employee-tab-item-2'){
            $('#employee-tab-item-2').addClass('active border-b-red-600 text-[#831b94]');
            $('#employee-tab-item-1').removeClass('active border-b-red-600 text-[#831b94]');
