        ...
        <div class="flex justify-between items-center border-b p-2 pl-4">
            ...
            <div class="">
                <div class="modal-action mt-0">
                    <form method="dialog">
                        <button class="w-9 aspect-square rounded-full bg-neutral-50 hover:bg-[#831b94] hover:text-white duration-200"><i class="fa-solid fa-xmark"></i></button>
                    </form>
                </div>
            </div>
        </div>
            ...
            <form action="#" method="POST" enctype="multipart/form-data" onsubmit="return validateLateRequest('c_',document.getElementById('form_type').value)">
                ...
                <div class="p-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6 mt-2">
                        ...
                        <div class="col-span-1">
                            <label for="late_typeX" class="inputLabel">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6 mt-2" id="late_arrival_type">
                        <div>
                            <label for="lateRequestX" class="inputLabel">
                                Late Arival Date
                            </label>
                        ...
                        <div>
                            <label for="lateRequestY" class="inputLabel">
                                Late Arival Time
                            </label>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6 mt-2 hidden" id="early_exit_type">
                        <div>
                            <label for="earlyRequestY" class="inputLabel">
                                Early Exit Date
                            </label>
                        ...
                        <div>
                            <label for="earlyRequestX" class="inputLabel">
                                Early Exit Time
                            </label>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6 mt-2">
                        <div>
                            <label for="late_reasonX" class="inputLabel">
                                Justification
                            </label>
                        ...
                        <div>
                            <label for="c_late_remarks" class="inputLabel">
                                Remarks
                            </label>
...
{{-- <form action="{{ route('leaveRequest.store') }}" method="POST" enctype="multipart/form-data" onsubmit="return validateFormRequest('c_', 'lateRequest')">
    @csrf
    <div class="p-4">
